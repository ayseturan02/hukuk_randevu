...
<section class="content">
    <h2>Hoş Geldiniz</h2>
    <p>Hukuk Büromuz, yılların deneyimine sahip bir ekip tarafından yönetilmektedir. Size çeşitli hukuki konularda yardımcı olmak için buradayız. Müvekkillerimize profesyonel ve güvenilir hukuki hizmetler sunuyoruz.</p>
    <p>Alanlarımız arasında ceza hukuku, aile hukuku, iş hukuku, gayrimenkul hukuku ve daha fazlası bulunmaktadır. Sizin için en uygun çözümü bulmak için çaba gösteriyoruz.</p>
  </section>
  
  <footer>
    <p>&copy; 2023 Hukuk Bürosu | Tüm Hakları Saklıdır.</p>
  </footer>
</body>
</html>
