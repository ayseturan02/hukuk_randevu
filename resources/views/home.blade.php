    ...
    <div class="container">
        <header class="d-flex justify-content-center py-3" sty>
            <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a href="{{route("randevu")}}" class="nav-link">Randevu</a></li>
            ...
            <div class="col-md-3 text-end">
                <a href="{{(route("login"))}}"> <button type="button" class="btn btn-outline-primary me-2"><font style="vertical-align: inherit;">
                ...
                <a href="{{(route("register"))}}"> <button type="button" class="btn btn-outline-primary me-2"><font style="vertical-align: inherit;">
